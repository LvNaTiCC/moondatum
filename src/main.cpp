...
int main(int, char**)
{
    ...
    // Create window with graphics contextm
...
#endif
    {
        ...
        // 2. Show a simple window that we create ourselves. We use a Begin/End pair to create a named window.
        {
            ...
            ImGui::Begin("OpenGL Texture Text", nullptr, ImGuiWindowFlags_AlwaysAutoResize);
            ...
            ImGui::Text("pointer = %d", my_image_texture);
            ImGui::Text("size = %d x %d", my_image_width, my_image_height);
            ImGui::Text("path = %d x %d", my_image_width, my_image_height);
